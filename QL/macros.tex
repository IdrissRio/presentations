...
\lstdefinelanguage{JastAdd}{
  %keyword1&2&6
  morekeywords = [1]{import, predicate, exists, |, or, and, not, class, extends, this},
  %keyword3
  morekeywords = [2]{from, where, select, count}, %JASTADD keywords
  %keyword4
  morekeywords = [3]{int, string, @expr, @seqexpr}, %ASTnode typess
  %keyword5
