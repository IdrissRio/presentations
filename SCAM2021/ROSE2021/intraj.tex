...
\subtitle[{\color{ForestGreen}\textbf{ROSE 2021}}]
{
	\footnotesize{ROSE Festival
}
}
...
\section{IntraCFG \& IntraJ }
\begin{frame}[fragile]{Overview}
\only<1>{\includegraphics[scale=0.7]{img/1.pdf}}%
\only<2>{\includegraphics[scale=0.7]{img/2.pdf}}%
\only<3>{\includegraphics[scale=0.7]{img/3.pdf}}%
\only<4>{\includegraphics[scale=0.7]{img/4.pdf}}%
\end{frame}


\begin{frame}[fragile]{Overview}
\only<1>{\includegraphics[scale=0.65]{img/5.pdf}}%
\only<2>{\includegraphics[scale=0.65]{img/6.pdf}}%
\only<3>{\includegraphics[scale=0.65]{img/7.pdf}}%
\only<4>{\includegraphics[scale=0.65]{img/8.pdf}}%
\end{frame}
